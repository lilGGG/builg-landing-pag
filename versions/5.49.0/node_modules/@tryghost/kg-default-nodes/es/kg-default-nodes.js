    ...
    return {
      form: nodeElem => {
        ...
        if (nodeElem.tagName === 'FORM' && isSignupNode) {
          return {
            conversion(domNode) {
              const style = domNode.getAttribute('style')?.includes('background-image') ? 'image' : 'default';
...
class SignupNode extends KoenigDecoratorNode {
  ...
  isEmpty() {
    return !this.__backgroundColor && !this.__backgroundImageSrc && !this.__buttonColor && !this.__buttonText && !this.__disclaimer && !this.__header && !this.__labels.length && !this.__subheader;
  }
